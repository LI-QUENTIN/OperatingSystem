...
CF		:=	-march=$(ISA) -mabi=$(ABI) -mcmodel=medany -fno-pie -fno-builtin -ffunction-sections -fdata-sections -nostartfiles -nostdlib -nostdinc -static -lgcc -Wl,--nmagic -Wl,--gc-sections -g 
TEST_SCHED  :=  0
